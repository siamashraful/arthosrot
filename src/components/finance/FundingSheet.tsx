 ...
 *
 * The trigger lives on the hero card, but the sheet is portalled to <body>:
 * the top layer ignores the card's overflow/z-index, yet CSS descendant rules
 * (.hero-card .btn-primary, .muted, .field-label, --focus-ring) would still
 * cascade into it and paint chalk-on-dark controls on a light glass sheet.
 */
